...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/axios.js'), 'axios.js')
  resolveStoreModules(require('../store/categories.js'), 'categories.js')
  resolveStoreModules(require('../store/media.js'), 'media.js')
  resolveStoreModules(require('../store/notification.js'), 'notification.js')
  resolveStoreModules(require('../store/order.js'), 'order.js')
  resolveStoreModules(require('../store/parent.js'), 'parent.js')
  resolveStoreModules(require('../store/teachers.js'), 'teachers.js')
  resolveStoreModules(require('../store/title.js'), 'title.js')
